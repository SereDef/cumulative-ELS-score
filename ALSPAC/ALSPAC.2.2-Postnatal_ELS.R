...
# STARTED_NURSERY
# ------------------------------------------------------------------------------
postnatal_stress$started_nursery_18m <- postn$kd513a_rec	 # CH started nursery
postnatal_stress$started_nursery_30m <- postn$kf463a_rec	 # CH started new creche since 18 months
postnatal_stress$started_nursery_3y	 <- postn$kj473a_rec	 # CH started new creche
...
postnatal_stress$acquired_new_parent_3y   <- postn$kj468a_rec  # CH got new parent
...
# CHAGE_CARER
# ------------------------------------------------------------------------------
postnatal_stress$change_carer_18m <- postn$kd511a_rec  # CH changed carer
postnatal_stress$change_carer_30m <- postn$kf461a_rec  # CH changed carer since 18 months
postnatal_stress$change_carer_3y	<- postn$kj471a_rec  # CH changed carer 
...
postnatal_stress$friend_relative_ill_8m  <- postn$f225a_rec  # Friend or relative ill
...
postnatal_stress$friend_relative_ill_9y  <- postn$p2005a_rec	 # Mum's friend or relative ill since 7th birthday
# ------------------------------------------------------------------------------
...
postnatal_stress$partner_died_8m  <- postn$f220a_rec  # Death of partner
...
postnatal_stress$burglary_or_car_theft_5y  <- postn$k4039a_rec # Mum's house or car burgled since 8 months
...
# SEPARATED_FROM_SMBD
# ------------------------------------------------------------------------------
postnatal_stress$separated_from_smbd_18m <- postn$kd512a_rec  # CH separated from someone else
postnatal_stress$separated_from_smbd_30m <- postn$kf462a_rec  # CH sep.from somebody since 18 months
postnatal_stress$separated_from_smbd_3y  <- postn$kj472a_rec  # CH separated from someone else
...
# CH_HAD_FRIGHT 
# ------------------------------------------------------------------------------
postnatal_stress$ch_had_fright_18m <-	postn$kd503a_rec  # CH had fright 
postnatal_stress$ch_had_fright_30m <-	postn$kf453a_rec  # CH had fright since 18 months
postnatal_stress$ch_had_fright_3y  <-	postn$kj463a_rec  # CH had shock 
...
postnatal_stress$major_financial_problems_8m  <- postn$f244a_rec  #  Major financial problems
postnatal_stress$major_financial_problems_21m <- postn$g324a_rec  
postnatal_stress$major_financial_problems_3y  <- postn$h234a_rec  
postnatal_stress$major_financial_problems_4y  <- postn$j324a_rec  
postnatal_stress$major_financial_problems_5y  <- postn$k4024a_rec 
postnatal_stress$major_financial_problems_6y  <- postn$l4024a_rec 
...
postnatal_stress$divorce_8m	 <- repmeas(postn[,c('f228a_rec', 'f237a_rec')])  # Divorce | Separated from partner
...
postnatal_stress$physical_violence_30m <- postn$kj464a_rec  # CH physically hurt by someone
postnatal_stress$physical_violence_3y  <- postn$kf454a_rec  # CH physically hurt since 18 months
...
# sexual_abuse
# ------------------------------------------------------------------------------
postnatal_stress$sexual_abuse_18m <- postn$kd505a_rec  # CH sexually abused
postnatal_stress$sexual_abuse_30m <- postn$kj465a_rec  # CH sexually abused
postnatal_stress$sexual_abuse_3y  <- postn$kf455a_rec  # CH sexually abused since 18 months
